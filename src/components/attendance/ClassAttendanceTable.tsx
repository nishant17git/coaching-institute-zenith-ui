...
export function ClassAttendanceTable({ 
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-white/50 p-4 rounded-lg border">
        ...
        <Button 
          ...
          className="bg-apple-green hover:bg-green-600 text-white h-8 px-3 whitespace-nowrap"
          disabled={isSaving}
        >
      ...
      {students.length > 0 ? (
        <div className="bg-white/50 backdrop-blur-sm border rounded-lg overflow-hidden">
            ...
            <Table>
              ...
              >
                {students.map((student, index) => (
                  <motion.tr key={student.id} variants={item} className="bg-white/40 hover:bg-gray-50/50">
                    <TableCell className="py-2 pl-4 font-medium">{index + 1}</TableCell>
                    <TableCell className="py-2">
                      <div className="flex items-center gap-2">
                        <div className="h-7 w-7 rounded-full bg-gray-100/80 flex items-center justify-center shrink-0">
        ...
        <div className="flex flex-col items-center justify-center py-8 px-4 border rounded-lg bg-white/50 text-center">
