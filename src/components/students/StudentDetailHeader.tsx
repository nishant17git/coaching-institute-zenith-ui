      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <h1 className="md:text-2xl font-semibold tracking-tight text-2xl">Profile</h1>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 rounded-xl overflow-hidden shadow-sm">
          <div className="px-5 py-5 md:px-8 md:py-6 flex flex-col md:flex-row gap-6 items-center md:items-start mx-[16px]">
